...
def create_reporting_tables(historic_endpoints_data, latest_endpoint_data, performance_db_path):
    ...
    cursor.executemany("""
            INSERT INTO reporting_historic_endpoints (
                organisation, name, collection, pipeline, endpoint, endpoint_url, licence, latest_status, exception, resource, 
    ...
    cursor.executemany("""
            INSERT INTO reporting_latest_endpoints (
                organisation, name, collection, pipeline, endpoint, endpoint_url, licence, latest_status, days_since_200, exception, resource, 
